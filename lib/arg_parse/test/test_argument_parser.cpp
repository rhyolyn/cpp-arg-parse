...
//);
//
//// Test cases for ArgumentParser::parse
//struct ArgumentParserParseTestCase {
//    std::vector<std::string> args;
//    bool expected_success;
//    std::string expected_ip;
//    int expected_port; // changed from std::string
//};
//
...
//
//        // Missing arguments
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--port", "8080"}, false, "", 0}, "FailsWithMissingIp"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--ip", "127.0.0.1"}, false, "", 0}, "FailsWithMissingPort"},
//        TestCase<ArgumentParserParseTestCase>{{{"program"}, false, "", 0}, "FailsWithNoArguments"},
//
//        // Missing values
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--ip"}, false, "", 0}, "FailsWhenIpRequiresValue"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--port"}, false, "", 0}, "FailsWhenPortRequiresValue"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--port", "8080", "--ip"}, false, "", 0}, "FailsWhenIpRequiresValueAtEnd"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--ip", "127.0.0.1", "--port"}, false, "", 0}, "FailsWhenPortRequiresValueAtEnd"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--ip", "--port"}, false, "", 0}, "FailsWhenIpAndPortAreMissingValues"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--port", "--ip"}, false, "", 0}, "FailsWhenPortAndIpAreMissingValues"},
//
//        // Unknown / invalid
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--unknown", "value", "--ip", "127.0.0.1", "--port", "8080"}, false, "", 0}, "FailsWithUnknownArgument"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "--ip", "127.0.0.1", "--port", "8080", "extra"}, false, "", 0}, "FailsWithExtraArgument"},
//        TestCase<ArgumentParserParseTestCase>{{{"program", "positional", "--ip", "127.0.0.1", "--port", "8080"}, false, "", 0}, "FailsWithPositionalArgument"}
//    ),
